...
class TestField(unittest.TestCase):
    ...
    def test_lt(self):
        ...
        self.assertFalse(self.field2 < self.field1)
        self.assertTrue(self.field1 < self.field3)
    ...
    def test_gt(self):
        self.assertFalse(self.field1 > self.field2)
        self.assertTrue(self.field2 > self.field1)
        self.assertFalse(self.field1 > self.field3)
