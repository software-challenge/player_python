...
from src.SoftwareChallengeClient.server_api.protocol.ProtocolPacket import AdminLobbyRequest
from src.SoftwareChallengeClient.server_api.protocol.Shared import SlotDescriptor
