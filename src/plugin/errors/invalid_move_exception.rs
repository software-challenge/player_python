...
impl InvalidMoveException {
    ...
    pub fn message(&self) -> String {
        match self {
            ...
            Self::PushActionRequired => "Wenn du auf einem gegnerischen Schiff landest, muss darauf eine Abdrängaktion folgen.".to_string(),
            Self::SandBankEnd => "Zug auf eine Sandbank muss letzte Aktion sein.".to_string(),
            Self::FirstActionAccelerate => "Du kannst nur in der ersten Aktion beschleunigen.".to_string(),
