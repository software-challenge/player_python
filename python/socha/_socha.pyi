...
class Move:
    ...
    def __init__(self, actions: List[Accelerate | Advance | Push | Turn]) -> None: ...
...
class Ship:
    ...
    def update_position(self, distance: int, advance_info: AdvanceInfo) -> None: ...
...
class Push:
    ...
    def perform(self, state: GameState) -> Tuple[Ship, Ship] | BaseException: ...
...
class Field:
    ...
    def __init__(field_type: FieldType, passenger: Optional[Passenger]) -> None: ...
...
class Segment:
    ...
    def local_to_global(self, coordinates: CubeCoordinates) -> CubeCoordinates: ...
    def global_to_local(self, coordinates: CubeCoordinates) -> CubeCoordinates: ...
...
class Board:
    ...
    def find_segment(self, coordinate: CubeCoordinates) -> Optional[Segment]: ...
    def neighboring_fields(self, coords: CubeCoordinates) -> List[Optional[Field]]: ...
...
class GameState:
    ...
    def coal_for_action(self, action: Accelerate | Advance | Push | Turn) -> int: ...
